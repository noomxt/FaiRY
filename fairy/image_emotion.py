...
def main():
    ...
    # cognify 모듈에서 추천 가져오기
    recommendations = cognify.get_recommendations(result['emotion_eng'])

    print("\n=== 추천 활동 & 노래 ===")
    print(f"추천 활동: {recommendations['activity']}")
    print(f"추천 노래: {recommendations['song']}")
